    ...
    <div class="bg-white col-span-1 rounded-xl mt-5 mb-5 mr-5">
      <div class="m-3">
        ...
        <div class="w-full h-[500px]">
          <ClientOnly>
            <MglMap :attribution-control="false" map-key="map-home"
              map-style="https://tiles.gisgo.vn/styles/google/satellite/style.json" :center="[106.6, 17.459]" :zoom="4"
              @map:load="onLoad" @map:zoomstart="true" @map:zoomend="false">
              <mgl-fullscreen-control />
              <mgl-attribution-control />
              <mgl-navigation-control />
              <mgl-scale-control />
              <mgl-geolocate-control />
              <mgl-marker v-for="(coordinate, index) in listCoor" :key="index"
                :coordinates="[coordinate.kinh_do, coordinate.vi_do]">
          ...
          <!-- <mgl-map :center="[106.6, 17.459]" :zoom="4" :attribution-control="false" @map:load="onLoad"
            @map:zoomstart="isZooming = true" @map:zoomend="isZooming = false">
            <mgl-marker v-for="(coordinate, index) in listCoor" :key="index"
              :coordinates="[coordinate.kinh_do, coordinate.vi_do]">
              <template v-slot:marker>
...
// import type { MglEvent } from '@indoorequal/vue-maplibre-gl'; // Type-only import
// import { LngLatLike, MapLayerMouseEvent } from 'maplibre-gl';


// MglDefaults.style = 'https://tiles.gisgo.vn/styles/google/satellite/style.json';

// const map = useMap();
const mapVersion = ref<string>();
const loaded = ref(0);
// const isZooming = ref(false);
// const center = [106.6, 17.459] as LngLatLike;
// const zoom = 4;
...
const listCoor = [
  { kinh_do: 105.8542, vi_do: 21.0285 },
  { kinh_do: 106.6297, vi_do: 10.8231 },
  { kinh_do: 108.2192, vi_do: 16.0544 },
  { kinh_do: 106.6951, vi_do: 20.8444 },
  { kinh_do: 109.2193, vi_do: 12.2389 },
  { kinh_do: 105.7460, vi_do: 10.0292 },
  { kinh_do: 107.5759, vi_do: 16.4633 },
  { kinh_do: 108.2493, vi_do: 10.9558 },
  { kinh_do: 103.8750, vi_do: 22.3299 },
  { kinh_do: 109.2190, vi_do: 13.7820 }
]


setTitleHeader("Hi! Trịnh Ngọc Tiến");
